...
def main():
    ...
    for k in range(10,max_k,5):
        for iter in range(num_iter):
            ...
            for _size in [128]:
                summary_dir = ".summary_azure/zoneout_0.05"

...
def get_argument_parser():
    ...
    parser.add_argument('--data_path', type=str, default='../data/enwiki9_text',
                        help='data directory containing input.txt')
    parser.add_argument('--info_path', type=str, default=None,
                       help='Information about the input file')
    parser.add_argument('--summary_path', type=str, default='.summary_wiki',
    ...
    parser.add_argument('--vocab', type=str, default="abcdefghijklmnopqrstuvwxyz ")
    parser.add_argument('--entropy', type=float, default=0)
    parser.add_argument('--dropout', type=float, default=1.0)     
    parser.add_argument('--print_every', type=int, default=10)
    parser.add_argument('--validate_every', type=int, default=100000000000000)
